    ...
    <div className="min-h-screen p-3 sm:p-4 md:p-6 lg:p-8">
      <div className="mb-4 sm:mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Ventas Mayoreo</h1>
            <p className="text-sm sm:text-base text-gray-600">Precios especiales para mayoristas</p>
          </div>
